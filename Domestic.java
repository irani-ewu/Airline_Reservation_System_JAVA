...
public class Domestic extends Reservation // Concept of INHERITANCE. Domestic is the subclass of Reservation
{
    // To book domestic flight tickets
    ...
    // Here starts the concept of POLYMORPHISM. Overriding the abstract methods of Reservation class by giving body
    @Override
    ...
    public void Book() // The method to calculate payment transaction
    {
        ...
        System.out.println("""
                                            1. Dhaka to Sylhet (Novoair)
                                            BST 2:25 pm (Saturday)
                                            1) Business Class: BDT 7500
                                            2) Economy Class: BDT 3000
                                            2. Chittagong to Dhaka (Novoair)
                                            BST 10:30 am (Sunday)
                                            1) Business Class: BDT 7500
                                            2) Economy Class: BDT 3000""");
        ...
        switch(choice1)
        {
            case 1 -> {
                ...
                switch (choice2) {
                    case 1 -> {
                        System.out.println("Pay BDT 7500");
                        pay=scan.nextInt();
                        if(pay<7500)
                        {
                            System.out.println("You need to pay "+(7500-pay)+" more to book.");
                        }
                        else
                        {
                    ...
                    case 2 -> {
                        System.out.println("Pay BDT 3000");
                        pay=scan.nextInt();
                        if(pay<3000)
                        {
                            System.out.println("You need to pay "+(3000-pay)+" more to book.");
                        }
                        else
                        {
                            System.out.println("Transaction Successful.");
